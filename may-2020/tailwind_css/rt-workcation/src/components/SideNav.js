...
const SideNav = () => {
  const [isCollapsed, setIsCollapsed] = useToogle(false);
  return (
    <section
    ...
    >
      ...
      <nav className='px-2 pt-4 hidden xl:block'>
        <button
          ...
          type='button'
          className='flex items-end px-2 py-2 text-base leading-6 font-medium rounded-md text-white bg-gray-900 focus:outline-none transition ease-in-out duration-150'
        >
          <svg
        ...
        <a
          href='dashboard'
          className='group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-white bg-gray-900 focus:outline-none focus:bg-gray-800 transition ease-in-out duration-150'
        >
          <svg
        ...
        <a
          href='team'
          className='mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium rounded-md text-gray-300 hover:text-white hover:bg-gray-800 focus:outline-none focus:text-white focus:bg-gray-800 transition ease-in-out duration-150'
        >
          <svg
            className='mr-4 h-6 w-6'
            stroke='currentColor'
